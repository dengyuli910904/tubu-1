...
<head>
    ...
    <link href="{{ URL::asset('css/lib/jquery-ui-1.10.2.custom.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('css/lib/jquery.dataTables.css') }}" type="text/css" rel="stylesheet" />
    <link href="{{ URL::asset('css/compiled/datatables.css') }}" type="text/css" rel="stylesheet" />
    ...
    @section('header')
     <header class="navbar navbar-inverse" role="banner">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="bannerlist"><img src="{{ URL::asset('img/logo.png') }}"></a>
        </div>
