...
<![endif]-->
        ...
        <link rel="shortcut icon" href="{{ URL::asset('admin/ico/favicon.ico')}}" type="image/x-icon" /> 
...
<body>
    ...
    <!--[if !IE]>-->
            ...
            <script src="{{ URL::asset('admin/assets/js/jquery-2.1.1.min.js')}}"></script>
    ...
    <script src="{{ URL::asset('admin/js/pages/login.js')}}"></script>
